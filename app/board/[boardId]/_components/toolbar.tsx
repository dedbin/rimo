  ...
  return (
    <div className="absolute top-1/2 left-2 transform -translate-y-1/2 flex flex-col gap-4">
      <div className="bg-white rounded-md shadow-md p-1.5 flex flex-col gap-y-1 items-center">
        ...
        />
        <Hint label="Pen" side="right" sideOffset={10}>
          <ToolButton
            label="pen (Ctrl+P)"
            icon={Pencil}
            onClick={() =>
            ...
            isActive={canvasState.mode === BoardCanvasMode.Pencil}
          />
        </Hint>
        <ToolButton
          label="stickers"
      ...
      <div className="bg-white rounded-md shadow-md p-1.5 flex flex-col items-center">
        <Hint label="Undo" side="right" sideOffset={10}>
          <ToolButton
            label="undo (Ctrl+Z)"
            icon={Undo2}
            onClick={undo}
        ...
        <Hint label="Redo" side="right" sideOffset={10}>
          <ToolButton
            label="redo (Ctrl+Y)"
            icon={Redo2}
            onClick={redo}
